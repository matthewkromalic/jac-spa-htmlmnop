      ...
      return(
        <div>
          ...
          (<div>
            ...
            <p className="weight">{country[0].name} is a unique country with a capital of {country[0].capital} and a population of {country[0].population.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}. 
            ...
            <img className="flagpic" src={country[0].flags.svg}/>
          </div>)
          )
          }
